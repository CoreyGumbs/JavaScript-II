...
console.log(fullNames, 'full name array');
...
console.log(firstNamesAllCaps, 'first name all caps');
...
console.log(runnersLargeSizeShirt, 'large shirt');
...
const donations = runners.reduce( (accumulator, currentValue) => accumulator + currentValue.donation, ticketPriceTotal);
...
const companies = runners.map((runner)=> runner.company_name).sort();

console.log(companies, 'companies');

// Problem 3
//We would like to see the total amount of donations made under $100
